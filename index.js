...
const sessdata = config.SESSION_ID.replace("DUTSVA_AI~", '');
...
console.log('DUTSVA_AI CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ ᴅᴜᴛsᴠᴀ_ᴀɪ ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴢᴜᴋᴀ ✅*
...
if(senderNumber.includes("263789544743")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, DUTSVA_AI STARTED ✅");
});
